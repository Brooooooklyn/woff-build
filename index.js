  ...
  case 'linux':
    switch (arch) {
      ...
      case 'riscv64':
        if (isMusl()) {
          localFileExisted = existsSync(
            join(__dirname, 'woff-build.linux-riscv64-musl.node')
          )
          try {
            if (localFileExisted) {
              nativeBinding = require('./woff-build.linux-riscv64-musl.node')
            } else {
              nativeBinding = require('@napi-rs/woff-build-linux-riscv64-musl')
            }
          } catch (e) {
            loadError = e
          }
          ...
          localFileExisted = existsSync(
            join(__dirname, 'woff-build.linux-riscv64-gnu.node')
          )
          try {
            if (localFileExisted) {
              nativeBinding = require('./woff-build.linux-riscv64-gnu.node')
            } else {
              nativeBinding = require('@napi-rs/woff-build-linux-riscv64-gnu')
            }
          } catch (e) {
            loadError = e
          }
      ...
      case 's390x':
        localFileExisted = existsSync(
          join(__dirname, 'woff-build.linux-s390x-gnu.node')
        )
        try {
          if (localFileExisted) {
            nativeBinding = require('./woff-build.linux-s390x-gnu.node')
          } else {
            nativeBinding = require('@napi-rs/woff-build-linux-s390x-gnu')
          }
        } catch (e) {
          loadError = e
        }
