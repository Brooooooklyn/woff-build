...
let __wasmFilePath = __nodePath.join(__dirname, 'woff-build.wasm32-wasi.wasm')
const __wasmDebugFilePath = __nodePath.join(__dirname, 'woff-build.wasm32-wasi.debug.wasm')
...
module.exports.convertWOFF2ToTTFAsync = __napiModule.exports.convertWOFF2ToTTFAsync
